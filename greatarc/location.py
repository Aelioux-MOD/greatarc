...
class Location:
    ...
    def calculate_distance(self, other_location, unit="km"): # Edit the text between "miles" and "km" to produce the different outputs.
        ...
        if unit == "miles":
            return distance_km * 0.621371  # Convert kilometers to miles
        return distance_km
